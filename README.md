...
An android Application builded by kotlin language, the application enable the user to track daily expenditures such as:-
food,retial,healthcare, and leisure activities.

---

## 🚀 Features
- add new expense➕
- Update old expense✏️
- Delete expense with warm massage🗑️
- Show All expenses In RecyclerView📋
- SearchFilter by categories and duration
- Save Date Locale💾
...
- LinkedIn: https://www.linkedin.com/in/abdeltawab-shabaan-a504a32a3?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app
